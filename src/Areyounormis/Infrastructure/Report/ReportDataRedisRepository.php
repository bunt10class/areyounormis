...
namespace Areyounormis\Infrastructure\Report;

use Core\Config;
use Predis\Client;

class ReportDataRedisRepository
{
    protected const USER_REPORT_REDIS_KEY = 'user-report';
    ...
    {
        return self::USER_REPORT_REDIS_KEY . ':' . $userId;
    }
}