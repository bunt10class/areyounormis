...
return [
    ...
    \Areyounormis\Infrastructure\ResourceData\ResourceDataRepositoryInterface::class => function (Container $container) {
        return $container->get(\Areyounormis\Infrastructure\ResourceData\KinopoiskDataRepository::class);
    },
